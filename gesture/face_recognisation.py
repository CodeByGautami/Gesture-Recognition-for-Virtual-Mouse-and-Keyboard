...
faces=cv2.CascadeClassifier('D:/new project/Eye_ball_cursor/haarcascade_frontalface_default.xml')

# to detect the eyes
eyes=cv2.CascadeClassifier('D:/new project/Eye_ball_cursor/haarcascade_eye.xml')
